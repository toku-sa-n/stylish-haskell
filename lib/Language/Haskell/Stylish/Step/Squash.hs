...
--------------------------------------------------------------------------------
squashMatch :: GHC.LMatch GHC.GhcPs (GHC.LHsExpr GHC.GhcPs) -> Editor.Edits
squashMatch lmatch =
  case GHC.m_grhss match of
    GHC.GRHSs _ [lgrhs] _
...
step :: Step
step =
  makeStep "Squash" $ \ls (module') ->
    let changes =
          foldMap squashFieldDecl (everything module') <>
          foldMap squashMatch (everything module')
